...
! function() {
    ...
    function ce(e, t, n) {
        ...
        if (n = n || e, void 0 !== e.length) {
            ...
            for (r in e)
                if (ke(e, r) && !1 === t.call(n, e[r], r, e)) return !1;
        return !0
    }
    ...
    function no(e, n) {
        var r;
        return e && (r = {}, ni(e = "string" == typeof e ? {
            "*": e
        } : e, function(e, t) {
                    ...
                    if (r) {
                        ...
                        if (o) {
                            ...
                            if (i) {
                                ...
                                if (a) {
                                    var u = [r, o, i, a];
                                    for (N = u.length - 1; N-- && u[N] === u[N + 1];); - 1 < N && n || (p[e + t] = -1 === N ? u[0] : u.join(" "), delete p[e + "-top" + t], delete p[e + "-right" + t], delete p[e + "-bottom" + t], delete p[e + "-left" + t])
                                }
                            }
                        }
                    }
    ...
    var fo = Tr(["h1", "h2", "h3", "h4", "h5", "h6"]),
        ...
        si = (ci.prototype.bind = function(e, t, n, r) {
            function o(e) {
            ...
            if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
                ...
                for (var m = t.split(" "), g = m.length; g--;) c = o, s = l = !1, "DOMContentLoaded" === (u = m[g]) && (u = "ready"), f.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, lo({
                    type: u
                ...
                }), (a = f.events[i][u]) ? "ready" === u && f.domLoaded ? n(lo({
                    type: u
                })) : a.push({
                    func: n,
                    scope: r
    ...
    function xa(e, t) {
        var n, r = (t = t || Aa).createElement("div"),
    ...
    function _a(e, n) {
        ...
        var t, s = e ? e.ownerDocument || e : Ri,
            n = s.defaultView;
                ...
                return 1 === g && 0 === p ? function(e) {
                    ...
                    if (l) {
                        ...
                        if (s = [v ? l.firstChild : l.lastChild], v && d) {
                            ...
                            for (;
                                (i = ++u && i && i[c] || (a = u = 0) || s.pop()) && ((b ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[Ai] || (i[Ai] = {}))[m] = [Di, a]), i !== e)););
        ...
        pseudos: {
            ...
            contains: la(function(t) {
                return t = t.replace(ua, li),
                    function(e) {
                        return -1 < (e.textContent || e.innerText || mi(e)).indexOf(t)
                    }
            }),
            lang: la(function(n) {
                return Zi.test(n || "") || sa.error("unsupported lang: " + n), n = n.replace(ua, li).toLowerCase(),
                    function(e) {
                        var t;
                        do {
                ...
                for (var o, n, r, i = t.length, a = di.relative[t[0].type], u = a || di.relative[" "], s = a ? 1 : 0, c = ha(function(e) {
                    ...
                    if (n = di.relative[t[s].type]) f = [ha(va(f), n)];
                        ...
                        if ((n = di.filter[t[s].type].apply(null, t[s].matches))[Ai]) {
                            ...
                            return function e(m, g, p, h, v, t) {
                                return h && !h[Ai] && (h = e(h)), v && !v[Ai] && (v = e(v, t)), la(function(e, t, n, r) {
                                    var o, i, a, u = [],
                                        ...
                                        d = p ? v || (e ? m : c || h) ? [] : t : f;
                                    if (p && p(f, d, n, r), h)
                                        for (o = ba(d, s), h(o, [], n, r), i = o.length; i--;)(a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
                                    if (e) {
                                        if (v || m) {
                                            if (v) {
                            ...
                            }(1 < s && va(f), 1 < s && pa(t.slice(0, s - 1).concat({
                                value: " " === t[s - 2].type ? "*" : ""
                            })).replace(Xi, "$1"), n, s < r && e(t.slice(s, r)), r < i && e(t = t.slice(r)), r < i && pa(t))
                        }
                        f.push(n)
                    } return va(f)
            }(t[n]))[Ai] ? r : o).push(i);
        ...
        Pa = function(e, t, n, r) {
            ...
            if (Ca(t)) t = xa(t, ja(e[0]));
                ...
                if (t = Xa.makeArray(t), r)
                    ...
                    for (o = 0; o < t.length; o++) Pa(e, t[o], n, r);
                return e
            }
            if (t.nodeType)
    ...
    Ea.fn = Ea.prototype = {
        ...
        init: function(e, t) {
            ...
            if (Ca(e)) {
                ...
                if (n[1])
                    for (r = xa(e, ja(t)).firstChild; r;) Ra.call(o, r), r = r.nextSibling;
                else {
        ...
        add: function(e, t) {
            ...
            if (!1 !== t)
                for (n = Xa.unique(this.toArray().concat(Xa.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++) this[r] = n[r];
    ...
    var eu = Za.DOM,
        tu = Et.each,
        nu = Et.grep,
        ru = (ou.prototype._setReferrerPolicy = function(e) {
    ...
    function ms(e, t) {
        ...
        return cc(a) ? n = function(e, t) {
            for (;
                (e = e.previousSibling) && cc(e);) t += e.data.length;
            return t
    ...
    function Ys(e, t, n, r, o) {
        ...
        if (t < 0) {
            ...
            for (; e = Xs(i.prev.bind(i), o);)
                if (n(e)) return e
        }
        if (0 < t) {
            if (a && n(e = Xs(i.next.bind(i), !0))) return e;
            for (; e = Xs(i.next.bind(i), o);)
                if (n(e)) return e
        }
        return null
    }
    ...
    function wl(t, e, n, r) {
        ...
        if ((i = dl(s) ? s.wrapper ? null : a.getParent(n, s.block, u) : i) || (o = a.getParent(n, "LI,TD,TH"), i = a.getParent(jn(n) ? n.parentNode : n, function(e) {
                return e !== u && df(t, e)
            }, o)), !(i = i && dl(s) && s.wrapper && lf(a, i, "ul,ol").reverse()[0] || i))
                ...
                i.lookup(t).each(function(e) {
                    ...
                    s = t, c = e, l = n, (u = o).undoManager.transact(function() {
                        ...
                        i.collapsed && !a && (n = kl(e = u, t = i, [{
                            inline: "span"
                        }]), t.setStart(n.startContainer, n.startOffset), t.setEnd(n.endContainer, n.endOffset), e.selection.setRng(t)), o.getRng().collapsed && !a ? (wu(r = Ml(u.getDoc(), l, s, c.decorate), xo), o.getRng().insertNode(r.dom), o.select(r.dom)) : Ll(o, !1, function() {
                            Pl(u, function(e) {
    ...
    function wf(r, l) {
        ...
        var p, h, v, b, y, C, x, w, S, E, k, N, _, A, R, D = "data-mce-selected",
            T = l.dom,
            O = Et.each,
            B = l.getDoc(),
            P = document,
    ...
    function Gf(e, t, n, r) {
        Xf(e, t, e.dom.defaultView.innerHeight, n, r);
        var o, i, a, u, s, c, l, f = (o = n.element, u = Jt(kt.fromDom(document)), a = (i = Rd).owner(o), s = Ad(i, a), c = Un(o), l = P(s, function(e, t) {
                var n = Un(t);
                return {
                    left: e.left + n.left,
                    top: e.top + n.top
    ...
    function fd(e) {
        var t, n, r = sd(e) ? (t = kt.fromDom(e.getBody()), ((n = Tt(t).dom.getSelection()) && 0 !== n.rangeCount ? ve.from(n.getRangeAt(0)) : ve.none()).map(cd).filter(ud(t))) : ve.none();
    ...
    function pd(n, e) {
        ...
        md(t), t.on("focusin", function() {
            ...
            t && ! function(e) {
                ...
                e.ownerDocument === document && (e === document.body || gd(t, e) || n.focusedEditor !== t || (t.fire("blur", {
                    focusedEditor: null
                }), n.focusedEditor = null))
            })
    ...
    var _d, Ad = function(r, e) {
        ...
        Dd = function(e, t, n, r) {
            ...
            var a, u, s, c, l = (a = kt.fromDom(n.startContainer), u = n.startOffset, s = function(e, t) {
                var n = Dn(e);
                if (0 === n.length || jf(e)) return {
                    element: e,
                    offset: t
                };
                if (t < n.length && !jf(n[t])) return {
                    element: n[t],
                    offset: 0
                };
                var r = n[n.length - 1];
    ...
    function yg(e, t) {
        var n, r, o, i, a, u, s, c, l = kt.fromDom(e.selection.getStart(!0)),
            f = Rl(e);
    ...
    function kg(e, o, i, t) {
        ...
        var r, a, u, s, c, l, f, d, m, g, p, h, v, b, y, C, x, w, S, E, k, N, _, A = (r = o, c = e.serialize(t), u = (a = r.createFragment(c)).firstChild, s = a.lastChild, u && "META" === u.nodeName && u.parentNode.removeChild(u), s && "mce_marker" === s.id && s.parentNode.removeChild(s), a),
    ...
    function Ng(e, t, n) {
        ...
        if (m.isDefaultPrevented()) e.fire("SetContent", {
            ...
            var b, y, C, x, w, S, E, k, N, _, A, R, D, T, O = {
    ...
    function Rg(u, s, e) {
        ...
        return _g(s) || (s = c.content), ve.from(u.getBody()).fold(J(s), function(e) {
            ...
            }(u, e, s, c) : (t = u, n = e, o = c, 0 === (r = s).length || /^\s+$/.test(r) ? (i = '<br data-mce-bogus="1">', "TABLE" === n.nodeName ? r = "<tr><td>" + i + "</td></tr>" : /^(UL|OL)$/.test(n.nodeName) && (r = "<li>" + i + "</li>"), r = (a = ks(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), a.toLowerCase()) ? (r = i, t.dom.createHTML(a, Ns(t), r)) : r || '<br data-mce-bogus="1">', Ag(t, r, o.no_selection), t.fire("SetContent", o)) : ("raw" !== o.format && (r = im({
                validate: t.validate
        ...
        if (a)
            if (b(a.length)) {
                ...
                for (var f = 0; f < a.length; f++)
                    if ("attributes" === r ? e.getAttrib(t, a[f]) : sl(e, t, a[f])) return 1;
        return 1
    }
    ...
    function Zp(e, t) {
        var n, r, o, i = kt.fromDom(t.commonAncestorContainer),
            a = ym(i, e),
            u = U(a, function(e) {
                return Or(e) || fo(e)
            }),
            ...
            selection: {
                getContent: function(e, t) {
                    return function(e, t, n) {
                        ...
                        i.getInner = !0;
                        var a, u, s, c, l, f, d, m, g = (u = i, s = (a = e).selection.getRng(), c = a.dom.create("body"), l = a.selection.getSel(), f = Ed(a, _l(l)), (d = u.contextual ? nh(kt.fromDom(a.getBody()), f).dom : s.cloneContents()) && c.appendChild(d), a.selection.serializer.serialize(c, u));
                                ...
                                if (g[e] && !k) {
                                    if ((t = l.firstChild) && 3 === t.type)
                                        if (0 < (n = t.value.replace(x, "")).length) t.value = n, t = t.next;
                                            ...
                                            for (r = t.next, t.remove(), t = r; t && 3 === t.type;) n = t.value, r = t.next, 0 !== n.length && !E.test(n) || (t.remove(), t = r), t = r;
                                    if ((t = l.lastChild) && 3 === t.type)
                                        if (0 < (n = t.value.replace(w, "")).length) t.value = n, t = t.prev;
                                        else
                                            for (r = t.prev, t.remove(), t = r; t && 3 === t.type;) n = t.value, r = t.prev, 0 !== n.length && !E.test(n) || (t.remove(), t = r), t = r
                                }
                                k && C[e] && (k = !1);
                                var a = Wh(R, h, C, l),
                                    u = l.parent;
                        ...
                        for (var t = pv("tr,td,th,tbody,thead,tfoot,table"), n = R.getNonEmptyElements(), r = R.getWhiteSpaceElements(), o = R.getTextBlockElements(), i = R.getSpecialElements(), a = function(e, t) {
                            ...
                            if (c.parent && !c.fixed)
                                if (o[c.name] && "li" === c.parent.name) {
                                    ...
                                    else c.parent && ("li" !== c.name ? R.isValidChild(c.parent.name, "div") && R.isValidChild("div", c.name) ? c.wrap(P(new Hd("div", 1))) : a(c) : !(d = c.prev) || "ul" !== d.name && "ol" !== d.name ? !(d = c.next) || "ul" !== d.name && "ol" !== d.name ? c.wrap(P(new Hd("ul", 1))) : d.insert(c, d.firstChild, !0) : d.append(c))
                                }
                        }
    ...
    function Gh(L, I) {
        ...
        return (t = U).addAttributeFilter("data-mce-tabindex", function(e, t) {
            ...
            serialize: function(e, t) {
                var n, r, o, i, a, u, s, c, l, f, d, m, g, p, h, v, b, y, C, x, w, S, E, k, N, _, A, R, D, T = _e({
                        format: "html"
                    }, t = void 0 === t ? {} : t),
                    O = (n = (m = e, E = g = T, (d = I) && d.hasEventListeners("PreProcess") && !E.no_events ? (h = g, x = (p = d).dom, w = m.cloneNode(!0), (S = document.implementation).createHTMLDocument && (b = S.createHTMLDocument(""), Et.each("BODY" === w.nodeName ? w.childNodes : [w], function(e) {
                        ...
                        node: w
                    }), y.fire("PreProcess", C), v && (x.doc = v), w) : m), o = Eo((r = T).getInner ? n.innerHTML : M.getOuterHTML(n)), r.selection || yo(kt.fromDom(n)) ? o : Et.trim(o)),
                ...
                return "tree" === T.format ? B : (k = I, N = T, _ = B, D = im(L, F).serialize(_), N.no_events || !k ? D : (A = k, R = _e(_e({}, N), {
                    content: D
    ...
    function ov(e, t, n, r) {
        var o, i, a, u, s, c, l, f, d = tv(n.forced_plugins),
            m = tv(r.plugins),
    ...
    function cv(e, t, n) {
        var r, o, i, a, u, s, c = kt.fromDom(e.getBody()),
    ...
    function lv(o) {
        ...
        function t(n, e) {
            if (void 0 === e && (e = !0), !o.removed && (r = (t = o).inline ? t.getBody() : t.getContentAreaContainer(), ve.from(r).map(kt.fromDom).map(In).getOr(!1))) return e && o.fire("BeforeOpenNotification", {
                notification: n
            }), M(c, function(e) {
    ...
    function Gv(l) {
        ...
        var u, s, c, d, m = Wv(),
            g = qv(),
            p = [],
            h = (d = iu(null), (c = l).on("change AddUndo", function(e) {
                d.set(_e({}, e.level))
            }), {
    ...
    function wb(e) {
        var n, r, o, t, i, a, u, s, c, l, f = kt.fromDom(e.getBody()),
    ...
    function Ib(e) {
        ...
        return Xn(o) && n.isBlock(o) && n.isEmpty(o) && (t = n.create("br", {
            "data-mce-bogus": "1"
        }), n.setHTML(o, ""), o.appendChild(t), r.setRng(ss.before(t).toRange())), !0
    }
    ...
    var My, Fy, Uy = R(Ty, ss.isAbove, -1),
    ...
    function Qy(e, t, n) {
        ...
        var o, i, a, u = Iy(U(xe(e.getElementsByTagName("*")), Ks)),
            s = U(u, R(Yy, n));
        if ((a = Gy(s, t, r)) && ((a = Gy(function(e, r, t) {
            ...
            }(e, a, r(a)), t, r)) && Ks(a.node))) return {
            node: (o = a).node,
            before: Wy(o, i = t) < Ky(o, i)
        };
        return null
    }
    ...
    function n0(t, e, n, r, o, i) {
        var a = rc(e, t.getBody(), n),
            ...
            s = e === My.Down;
        if (!u) return ve.none();
        var c, l = U((s ? UC : FC)(t.getBody(), qy(1), a), $y(1)),
            f = u.left,
            d = Gy(l, f);
        if (d && i(d.node)) {
    ...
    function fC(a, e) {
        function t(e) {
            ...
            if (!1 === a.getParam("keep_styles", !0)) c.setAttrib(o, "style", null), c.setAttrib(o, "class", null);
                ...
                for (; r[n.nodeName] && (jc(n) || Jc(n) || (t = n.cloneNode(!1), c.setAttrib(t, "id", ""), o.hasChildNodes() ? t.appendChild(o.firstChild) : i = t, o.appendChild(t))), (n = n.parentNode) && n !== F;);
        ...
        }(c, b), c.isEmpty(b) && iC(b), u.normalize(), c.isEmpty(u) ? (c.remove(u), r()) : (lC(a, u), Z0(a, u))), c.setAttrib(u, "id", ""), a.fire("NewBlock", {
            newBlock: u
        })))
    }
    ...
    function bC(e, t) {
        var n, r, o, i = (r = R(ib, n = e), o = ss.fromRangeStart(n.selection.getRng()), ty(r, n.getBody(), o).filter(hC));
    ...
    function o1(r) {
        ...
        "onselectionchange" in r.getDoc() || r.on("NodeChange click mouseup keyup focus", function(e) {
            ...
            !e || !xt.range && r.selection.isCollapsed() || Bl(r) && !t.isSameElementPath(e) && r.dom.isChildOf(e, r.getBody()) && r.nodeChanged({
                selectionChange: !0
            })
            ...
            if (s === u + 1 && a === e.endContainer) {
                ...
                if (f(c)) return function(e) {
                    ...
                    var r = function(e, t, n) {
                            var r = l.$,
                                o = vr(kt.fromDom(l.getBody()), "#" + w).fold(function() {
                                    return r([])
                                }, function(e) {
                                    return r([e.dom])
                                });
                            ...
                            var i = y.createRng();
                            t === n && xt.ie ? (o.empty().append('<p style="font-size: 0" data-mce-bogus="all">\xa0</p>').append(t), i.setStartAfter(o[0].firstChild.firstChild), i.setEndAfter(t)) : (o.empty().append(xo).append(t).append(xo), i.setStart(o[0].firstChild, 1), i.setEnd(o[0].lastChild, 0)), o.css({
    ...
    function x1(t, e) {
        ...
        N = _, (k = t).addCommand("delete", function() {
            ...
            ! function(e) {
                ...
                return !1
            }(x, n, w), "" !== x.getAttrib(n, vy) === r && !t || (x.setAttrib(n, vy, r ? S : null), x.setAttrib(n, "aria-placeholder", r ? S : null), C.fire("PlaceholderToggle", {
                state: r
            }), C.on(r ? "keydown" : "keyup", E), C.off(r ? "keyup" : "keydown", E)))
    ...
    var P1 = Yn,
        ...
        j1 = function(t, n, r) {
            ...
            if (r = Et.trim(r), e && -1 === Et.inArray(n, r) && (Et.each(Lv.dependencies(r), function(e) {
                ...
                i = r, a = e, yf(o = t, "PluginLoadError", {
                    message: u = cu.translate(["Failed to initialize plugin: {0}", i])
                }), cy(u, a), Uv(o, u)
            }
        },
        V1 = Za.DOM,
    ...
    function dx(e, t, n, r) {
        ...
        o.deactivate(), o.editorReadOnly !== i.editorReadOnly && tx(e, i.editorReadOnly), t.set(r), e.fire("SwitchMode", {
            mode: r
        })
    }
    ...
    var gx, px = {
        ...
        Sx = (Ex.prototype.add = function(e, n, t, r) {
            var o = this,
    ...
    var kx = Za.DOM,
        ...
        Dx = (Tx.prototype.render = function() {
            ...
            void 0 === e ? Qh(this, this.startContent, {
                format: "raw"
            }) : Qh(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged()
            ...
            (e = this).removed || (t = e._selectionOverrides, n = e.editorUpload, r = e.getBody(), o = e.getElement(), r && e.save({
                is_removing: !0
            }), e.removed = !0, e.unbindAllNativeEvents(), e.hasHiddenInput && o && yv.remove(o.nextSibling), e.fire("remove"), e.editorManager.remove(e), !e.inline && r && yv.setStyle(e.id, "display", e.orgDisplay), e.fire("detach"), yv.remove(e.getContainer()), Zh(t), Zh(n), e.destroy())
    ...
    function Tx(e, t, n) {
        ...
        this.mode = A, this.setMode = A.set, n.fire("SetupEditor", {
            editor: this
        }), this.execCallback("setup", this), this.$ = Xa.overrideDefaults(function() {
            return {
    ...
    var Lx, Ix = Za.DOM,
        ...
        $x = _e(_e({}, px), {
            ...
            add: function(e) {
                var n = this;
                return jx[e.id] === e || (null === n.get(e.id) && ("length" !== e.id && (jx[e.id] = e), jx.push(e), Vx.push(e)), Bx(!0), n.activeEditor = e, n.fire("AddEditor", {
                    editor: e
                }), Lx || (Lx = function(e) {
            ...
            remove: function(e) {
                var t, n, r = this;
                if (e) {
                    if (!X(e)) return n = e, l(r.get(n.id)) ? null : (Px(n) && r.fire("RemoveEditor", {
                        editor: n
                    }), 0 === Vx.length && window.removeEventListener("beforeunload", Lx), n.remove(), Bx(0 < Vx.length), n);
                    Fx(Ix.select(e), function(e) {
                        (n = r.get(e.id)) && r.remove(n)
                    })
                } else
                    for (t = Vx.length - 1; 0 <= t; t--) r.remove(Vx[t])
            },
        ...
        nw = {
            ...
            findBestRelativePosition: function(e, t, n, r) {
                for (var o, i = 0; i < r.length; i++)
                    if ((o = Wx(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y) return r[i];
                return null
            },
    ...
    Kx.extend = Jx = function(n) {
        function r() {
            var e, t, n;
            if (!Qx && (this.init && this.init.apply(this, arguments), t = this.Mixins))
    ...
    var aw, uw, sw, cw = Math.min,
        ...
        gw = _e(_e({}, px), {
            send: function(e) {
                ...
                if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = !1 !== e.async, e.data = e.data || "", gw.fire("beforeInitialize", {
                        settings: e
    ...
    var Cw = {
        ...
        xw = Et.extend($x, Cw),
        ww = xw;
    window.tinymce = ww, window.tinyMCE = ww,
        function(e) {
